...
- `f3e4d76e94f5b21073421d2ff8b2a1228a5dd55b` — Reviewed living-spec maintenance now records verified-to-verified outcomes only for new linked behavior or canonical intent; generated lifecycle churn cannot self-qualify. Evidence: `cli/commands/reconcile.mjs`, `cli/commands/retire.mjs`, `cli/commands/specs.mjs`, `cli/commands/sync.mjs`, `cli/docguard.mjs`, `cli/scanners/document-lifecycle.mjs`, `cli/scanners/lifecycle-context.mjs`, `cli/scanners/reconciliation.mjs`, `cli/scanners/requirement-evidence.mjs`, `cli/scanners/retirement-manifest.mjs`, `cli/scanners/spec-registry.mjs`, `cli/shared-sync-scope.mjs`, `cli/validators/traceability.mjs`, `cli/writers/file-transaction.mjs`, `cli/writers/spec-outcomes.mjs`, `docs-canonical/ARCHITECTURE.md`, `docs-canonical/DATA-MODEL.md`, `docs-canonical/REQUIREMENTS.md`, `docs-canonical/TEST-SPEC.md`, `tests/archive.test.mjs`, `tests/document-lifecycle.test.mjs`, `tests/file-transaction.test.mjs`, `tests/hooks-contract.test.mjs`, `tests/reconcile.test.mjs`, `tests/spec-completion.test.mjs`, `tests/spec-registry.test.mjs`. Accepted deviations: none. Successor: none.
- `a384a04479103b43587a2f79470b3b4a1031d242` — Reviewed the canonical architecture wording for living-spec maintenance eligibility; the positive rule preserves the delivered behavior and passes document quality. Evidence: `cli/commands/reconcile.mjs`, `cli/commands/retire.mjs`, `cli/commands/specs.mjs`, `cli/commands/sync.mjs`, `cli/docguard.mjs`, `cli/scanners/document-lifecycle.mjs`, `cli/scanners/lifecycle-context.mjs`, `cli/scanners/reconciliation.mjs`, `cli/scanners/requirement-evidence.mjs`, `cli/scanners/retirement-manifest.mjs`, `cli/scanners/spec-registry.mjs`, `cli/shared-sync-scope.mjs`, `cli/validators/traceability.mjs`, `cli/writers/file-transaction.mjs`, `cli/writers/spec-outcomes.mjs`, `docs-canonical/ARCHITECTURE.md`, `docs-canonical/DATA-MODEL.md`, `docs-canonical/REQUIREMENTS.md`, `docs-canonical/TEST-SPEC.md`, `tests/archive.test.mjs`, `tests/document-lifecycle.test.mjs`, `tests/file-transaction.test.mjs`, `tests/hooks-contract.test.mjs`, `tests/reconcile.test.mjs`, `tests/spec-completion.test.mjs`, `tests/spec-registry.test.mjs`. Accepted deviations: none. Successor: none.
- `7374d8c35deb68e77541525082fd94643494d802` — Reviewed taskless living-contract completion and status-preserving released maintenance with paired controls; all 1,866 tests and self-guard passed with no accepted deviations. Evidence: `cli/commands/reconcile.mjs`, `cli/commands/retire.mjs`, `cli/commands/specs.mjs`, `cli/commands/sync.mjs`, `cli/docguard.mjs`, `cli/scanners/document-lifecycle.mjs`, `cli/scanners/lifecycle-context.mjs`, `cli/scanners/reconciliation.mjs`, `cli/scanners/requirement-evidence.mjs`, `cli/scanners/retirement-manifest.mjs`, `cli/scanners/spec-registry.mjs`, `cli/shared-sync-scope.mjs`, `cli/validators/traceability.mjs`, `cli/writers/file-transaction.mjs`, `cli/writers/spec-outcomes.mjs`, `docs-canonical/ARCHITECTURE.md`, `docs-canonical/DATA-MODEL.md`, `docs-canonical/REQUIREMENTS.md`, `docs-canonical/TEST-SPEC.md`, `tests/archive.test.mjs`, `tests/document-lifecycle.test.mjs`, `tests/file-transaction.test.mjs`, `tests/hooks-contract.test.mjs`, `tests/reconcile.test.mjs`, `tests/spec-completion.test.mjs`, `tests/spec-registry.test.mjs`. Accepted deviations: none. Successor: none.
- `2a47de58f155f847b318f75267c43c2ee2828fd9` — Durable post-merge review at 2a47de5: living-contract completion and released-maintenance behavior are anchored to main after R9's durable outcome; complete reconciliation and self-guard passed with no accepted deviations. Evidence: `cli/commands/reconcile.mjs`, `cli/commands/retire.mjs`, `cli/commands/specs.mjs`, `cli/commands/sync.mjs`, `cli/docguard.mjs`, `cli/scanners/document-lifecycle.mjs`, `cli/scanners/lifecycle-context.mjs`, `cli/scanners/reconciliation.mjs`, `cli/scanners/requirement-evidence.mjs`, `cli/scanners/retirement-manifest.mjs`, `cli/scanners/spec-registry.mjs`, `cli/shared-sync-scope.mjs`, `cli/validators/traceability.mjs`, `cli/writers/file-transaction.mjs`, `cli/writers/spec-outcomes.mjs`, `docs-canonical/ARCHITECTURE.md`, `docs-canonical/DATA-MODEL.md`, `docs-canonical/REQUIREMENTS.md`, `docs-canonical/TEST-SPEC.md`, `tests/archive.test.mjs`, `tests/document-lifecycle.test.mjs`, `tests/file-transaction.test.mjs`, `tests/hooks-contract.test.mjs`, `tests/reconcile.test.mjs`, `tests/spec-completion.test.mjs`, `tests/spec-registry.test.mjs`. Accepted deviations: none. Successor: none.
